...
export default function DashboardPage() {
  return (
    <AppLayout variant="client">
      <PageHeader
        title="Mi Panel"
        description="Bienvenido, Baby Store S.R.L"
        action={
          <Link href="/catalogo">
      ...
      >
        {[
          ...
          return (
            ...
            >
              <Card className={`gap-4 p-6 border-t-4 ${stat.border}`}>
                <div
        ...
        <Card className="p-0 overflow-hidden">
          {recentOrders.map((order, index) => (
            <motion.div
              ...
              className="flex items-center justify-between border-b border-border/5 px-6 py-4 transition-colors hover:bg-vanilla-cream-600/30 last:border-b-0"
            >
