...
import { UserAdd01Icon, Mail01Icon, LockIcon, UserIcon, Building02Icon, SmartPhone01Icon, File01Icon } from "hugeicons-react";
      ...
      <div className="mx-auto flex min-h-[calc(100vh-12rem)] w-full max-w-lg items-center justify-center px-6 py-20">
        <motion.div initial={{ opacity: 0, y: 20 }} animate={{ opacity: 1, y: 0 }} transition={{ duration: 0.5 }} className="w-full max-w-lg">
          <div className="mb-10 text-center">
            ...
            <p className="mt-3 text-sm text-on-surface-variant">Completá el formulario para solicitar acceso al catálogo</p>
          </div>
            ...
            <form onSubmit={handleSubmit} className="flex flex-col gap-5">
              <div className="grid gap-5 md:grid-cols-2">
                <div className="flex flex-col gap-2">
                  <label className="text-label-sm text-on-surface">Razón Social</label>
                ...
                <div className="flex flex-col gap-2">
                  <label className="text-label-sm text-on-surface">Titular</label>
                  <div className="relative">
                    <UserIcon className="absolute top-3.5 left-4 size-4 text-on-surface-variant/50" />
                    <Input placeholder="Nombre completo" value={formData.titular} onChange={handleChange("titular")} className="pl-10" required />
                  </div>
                </div>
              </div>
              ...
              <div className="grid gap-5 md:grid-cols-2">
                <div className="flex flex-col gap-2">
                  ...
                  <div className="relative">
                    ...
                    <Input placeholder="20-12345678-9" value={formData.cuit} onChange={handleChange("cuit")} className="pl-10" required />
                  </div>
                </div>
                ...
                <div className="flex flex-col gap-2">
                  ...
                  <div className="relative">
                    ...
                    <Input placeholder="+54 9 11 1234-5678" value={formData.telefono} onChange={handleChange("telefono")} className="pl-10" />
                  </div>
                </div>
              </div>
