      ...
      >
        ...
        <section className="w-full px-4 pb-10 pt-10 md:px-12 lg:px-16 lg:pt-12">
          <motion.div
            ...
            className="relative mx-auto w-full max-w-[98vw] overflow-hidden rounded-[2rem] px-6 py-10 text-center md:px-12 md:py-14 lg:px-16 lg:py-16"
            style={{
          ...
          >
            ...
            <div className="relative z-10 mx-auto max-w-6xl">
              <motion.span
                ...
                whileInView={{ opacity: 1, y: 0 }}
                viewport={{ once: true }}
                className="mb-4 inline-block rounded-full bg-white/15 px-5 py-2 text-xs font-bold uppercase tracking-[0.2em] text-white backdrop-blur-sm"
              >
                Exclusivo Mayoristas
              </motion.span>

              <h2
                className="text-xl font-extrabold leading-[1.15] text-white md:text-4xl lg:text-5xl"
                style={{
                  fontFamily:
                    "'Plus Jakarta Sans', 'Inter', system-ui, sans-serif",
                  wordSpacing: "0.15em",
              ...
              <p
                className="mx-auto mt-5 w-full text-base leading-relaxed text-white/85 md:text-lg lg:text-xl"
                style={{
                  fontFamily: "'Manrope', 'Inter', system-ui, sans-serif",
                }}
              >
              ...
              <motion.div
                ...
                className="mt-6 flex flex-wrap items-center justify-center gap-4 text-xs text-white/75"
              >
                <span className="flex items-center gap-2">
                  <CheckmarkCircle01Icon className="size-4 text-white" />
                  Precios mayoristas
                </span>
                <span className="flex items-center gap-2">
                  <CheckmarkCircle01Icon className="size-4 text-white" />
              ...
              >
                {!isAuthenticated ? (
                  <Link href={ROUTES.REGISTER}>
                    <Button
                      size="lg"
                      className="mt-7 gap-2 rounded-[2rem] bg-[#b7102a] px-8 text-sm font-bold text-white shadow-xl hover:bg-[#a00f25] hover:shadow-2xl"
                      style={{
                        fontFamily: "'Manrope', 'Inter', system-ui, sans-serif",
                      }}
                    >
                  ...
                  <Link href={ROUTES.DASHBOARD}>
                    <Button
                      size="lg"
                      className="mt-7 gap-2 rounded-[2rem] bg-white/15 px-8 text-sm font-bold text-white shadow-xl hover:bg-white/25 backdrop-blur-sm"
                      style={{
                        fontFamily: "'Manrope', 'Inter', system-ui, sans-serif",
                      }}
                    >
